...
\begin{figure}[!h]
 ...
 ~
  ...
  \caption{Input image: (a) \texttt{.png} input file; (b) user-interpretation of plans as wire-frame drawings (red)}
  \label{fig:input-png}
 \end{figure}
...
\begin{figure*}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=\textwidth]{images/ward} 
...
\subsubsection*{Cross-storey user navigation} The FIVE Web Framework also provides
